...
public class Male_Workout_Activity extends AppCompatActivity {
    private ImageView playButton, rightButton, leftButton, background;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_male_workout);
    ...
    private void setupMediaPlayer() {
        ...
        musicSeekBar.setMax(mediaPlayer.getDuration() / 1000); // Set seek bar max value in seconds
    }
    ...
    private void updateAbovePlayText() {
        // Use currentTrackIndex to get the name of the current song
